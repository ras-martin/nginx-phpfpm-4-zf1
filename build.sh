...
usage() {
  ...
  >&2 echo "    alpine-3.11:amd64 ..... Alpine Linux v3.11, architecture amd64: uses PHP 7.3, Nginx 1.16"
  exit 1
}
...
case "$1" in
  alpine-3.10:amd64) build "alpine-3.11:amd64" ;;
  all) build "alpine-3.11:amd64" ;;
  *) usage ;;
esac
